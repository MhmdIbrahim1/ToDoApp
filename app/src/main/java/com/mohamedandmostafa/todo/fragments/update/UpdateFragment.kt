package com.mohamedandmostafa.todo.fragments.update
...
import com.mohamedandmostafa.todo.databinding.FragmentUpdateBinding
...
class UpdateFragment : Fragment() {
    ...
    private fun updateItem() {
        ...
        if (validation) {
            ...
            Toast.makeText(requireContext(), "Please fill out any field!.", Toast.LENGTH_SHORT)
                .show()
        }
    }
